  ...
  theme: {
    extend: {
      colors: {
        ...
        // Голубой — второй акцент бренда: им подсвечиваются цифры, показатели и
        // вторая строка заголовка. Синий (primary) остаётся цветом действия,
        // поэтому кнопка и акцент не спорят друг с другом.
        sky: {
          50: '#EFF8FF',
          100: '#DBEEFF',
          200: '#BCE0FF',
        ...
        // Светлый фон страницы — белый с голубым подтоном, карточки на нём белые.
        canvas: '#F2F6FE',
