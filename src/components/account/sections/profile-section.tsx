...
export function ProfileSection({
  ...
  return (
    <section className={cardCls}>
      <h2 className="mb-5 text-base font-semibold text-navy dark:text-white">{t('profile.title')}</h2>
      <form onSubmit={save} className="space-y-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label htmlFor="acc-name" className="mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400">
              {t('name')}
            </label>
            <input
              id="acc-name"
          ...
          <div>
            <label htmlFor="acc-last" className="mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400">
              {t('lastName')}
            </label>
            <input
              id="acc-last"
        ...
        <div className="flex items-center gap-3">
          <Button type="submit" disabled={saving} className="rounded-control">
