  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary-500 px-1 text-[10px] font-semibold text-primary-950">
            {unread > 9 ? '9+' : unread}
          </span>
        )}
      </button>
