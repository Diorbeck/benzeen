              ...
              <div className="flex flex-wrap items-end gap-2">
                ...
                {o.status === 'COURIER_ASSIGNED' && (
                  <form action={markOnRouteAction}>
                    ...
                    <button
                      type="submit"
                      className="inline-flex h-9 items-center justify-center rounded-lg bg-primary-500 px-4 text-xs font-semibold text-primary-950 transition hover:bg-primary-600"
                    >
                      В пути
                    </button>
                  </form>
