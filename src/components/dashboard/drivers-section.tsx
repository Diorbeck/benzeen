      ...
      {drivers.length === 0 ? (
        ...
        >
          <div className="mb-6 rounded-2xl bg-primary-500/10 p-5">
            <Users className="h-14 w-14 text-primary-800 dark:text-primary-400" />
          </div>
                ...
                <div className="mb-4 flex items-start justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="rounded-xl bg-primary-500/10 p-2">
                      <Users className="h-5 w-5 text-primary-800 dark:text-primary-400" />
                    </div>
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {driver.carIds.map((carId) => {
                          ...
                          return (
                            <span
                              key={carId}
                              className="inline-flex items-center gap-1 rounded-full bg-primary-500/10 px-2 py-1 text-xs font-medium text-primary-800 dark:text-primary-400"
                            >
