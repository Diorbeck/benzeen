    ...
    <div className={className}>
      <div className="relative h-[320px] w-full overflow-hidden rounded-card border border-gray-200/60 dark:border-white/10 md:h-[400px]">
        ...
        <button
          ...
          onClick={locateMe}
          disabled={locating}
          className="absolute right-3 top-3 z-10 flex min-h-[40px] items-center gap-1.5 rounded-control bg-white px-4 py-2 text-xs font-medium text-gray-700 shadow-soft transition hover:text-primary-800 disabled:opacity-60 dark:bg-navy-800 dark:text-gray-200"
        >
