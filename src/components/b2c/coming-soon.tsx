  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy-900 text-gray-900">
      ...
      <main className="mx-auto flex min-h-[70vh] max-w-5xl flex-col items-center justify-center px-5 py-20 text-center sm:px-8">
        ...
        >
          <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-50 dark:bg-primary-500/15 text-primary-600 dark:text-primary-400">
            <Clock className="h-8 w-8" aria-hidden />
          </span>
          <p className="mt-6 text-sm font-medium uppercase tracking-wide text-primary-600 dark:text-primary-400">
            {t(`${section}.title`)}
          </p>
          ...
          <Link
            href={`/${safeLocale}`}
            className="mt-8 inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-navy-900 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 transition-colors hover:border-primary-200 dark:hover:border-primary-500/40 hover:text-primary-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
          >
