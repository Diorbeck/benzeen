        ...
        {draftRestored && (
          <div className="flex items-center justify-between gap-3 rounded-control bg-gray-100 dark:bg-white/10 px-4 py-3 text-sm text-navy dark:text-white">
            ...
            <button
              ...
              className="shrink-0 font-medium text-primary-800 dark:text-primary-400 underline-offset-2 hover:underline"
            >
              {t("draftClear")}
            </button>
          </div>
            ...
            <div className="mb-3 space-y-2">
              {cars.map((c) => (
                ...
                >
                  ...
                  {!usingNewCar && carId === c.id && (
                    <Check className="h-4 w-4 shrink-0 text-primary-800 dark:text-primary-400" />
                  )}
                </button>
              ))}
              <button
            ...
            <div className="space-y-3">
              <Field label={t("plateLabel")}>
                ...
                {plateMatch && (
                  ...
                  >
                    <Car
                      className="h-4 w-4 shrink-0 text-primary-800 dark:text-primary-400"
                      aria-hidden
                    />
                    <span>
                      {t("plateMatch")}{" "}
          ...
          {locations.length > 0 && (
            <div className="mb-3 flex flex-wrap gap-2">
              {locations.map((l) => (
                ...
                >
                  <Star
                    className={`h-3.5 w-3.5 shrink-0 text-primary-800 dark:text-primary-400 ${
          ...
          {loggedIn &&
            ...
            (savingAddr ? (
              ...
              <button
                ...
                className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-primary-800 dark:text-primary-400 hover:text-primary-900"
              >
    ...
    <div className="mx-auto max-w-lg space-y-4">
      ...
      >
        <span className="flex items-center gap-2 text-base font-semibold text-navy dark:text-white">
          <RotateCcw
            className="h-5 w-5 text-primary-800 dark:text-primary-400"
            aria-hidden
          />
    ...
    <section className="rounded-card border border-gray-200 dark:border-white/10 bg-white dark:bg-navy-900 p-5 sm:p-6">
      <div className="mb-5 flex items-center gap-2.5">
        ...
        <h2 className="font-editorial text-[21px] font-semibold leading-tight tracking-[-0.01em] text-navy dark:text-white sm:text-[22px]">
          <span className="mr-2 tabular-nums text-primary-800 dark:text-sky-300">
        ...
        <label className="mt-4 flex cursor-pointer items-start gap-2.5 rounded-control bg-gray-100 dark:bg-white/10 px-3 py-2.5 text-sm">
          ...
          <span className="text-navy dark:text-white">
            <span className="flex items-center gap-1.5 font-medium">
              <Gift
                className="h-4 w-4 text-primary-800 dark:text-primary-400"
                aria-hidden
              />
        ...
        {step === "phone" ? (
          ...
          >
            ...
            <button
              ...
              onClick={onBack}
              disabled={busy}
              className="w-full text-center text-sm text-gray-500 dark:text-gray-400 hover:text-primary-800"
            >
              {t("login.changePhone")}
            </button>
          </form>
