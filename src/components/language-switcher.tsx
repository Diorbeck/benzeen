    ...
    <div className={cn('relative', className)} ref={ref}>
      <button
        ...
        className={cn(
          ...
          'text-gray-700 transition-colors hover:border-primary-500/40 hover:bg-primary-500/5 hover:text-primary-900',
              ...
              <li key={code} role="option" aria-selected={isActive}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-primary-500/10 font-medium text-primary-800 dark:text-primary-400'
