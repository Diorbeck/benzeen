      ...
      <div className="card-premium space-y-3 p-6">
        ...
        >
          ...
          <div className="md:col-span-2 flex justify-end">
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-lg bg-primary-500 px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-primary-600"
            >
              Добавить компанию
            </button>
          </div>
